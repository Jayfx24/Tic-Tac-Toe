const gameBoard = (function (){
    ...
    function checkWinner(marker){
        ...
        return winPattern.find(pattern => pattern.every(index => board[index] == marker));
    } 
...
const displayController = {
    ...
    displayEndGame : function(){
        ...
        elements.gameOverDiv.classList.add('show'); 
        // gameOverDiv.style.display = 'block';

        gameOverDiv.classList.add('game-over-active');
    ...
    displayBoard : function(){
        ...
        // const playDialog = document.querySelector('.again-dialog')
